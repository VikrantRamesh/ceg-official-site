...
import curve_gray from "../assets/images/gray_curve.jpg";
...
const VisionMission = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${curve_gray})`,
      }}
      backgroundImage={curve_gray}
    >
      ...
      <div className="relative z-10 p-8 text-black">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          {/* Vision Section */}
          <div className="bg-white bg-opacity-80 b  ackdrop-filter backdrop-blur-sm p-6 shadow-lg rounded-lg flex flex-col justify-between min-h-[300px] transform hover:scale-105 transition duration-300">
            <div>
              <div className="flex items-center mb-4">
                <FaBullseye
                  ...
                  style={{ color: "#2b2a4c" }}
                />
                <h2 className="text-3xl font-bold" style={{ color: "#2b2a4c" }}>
                  Vision
                </h2>
              </div>
          ...
          {/* Mission Section */}
          <div className="bg-white bg-opacity-80 backdrop-filter backdrop-blur-sm p-6 shadow-lg rounded-lg flex flex-col justify-between min-h-[300px] transform hover:scale-105 transition duration-300">
            <div>
              <div className="flex items-center mb-4">
                <FaLightbulb
                  className="text-5xl mr-4"

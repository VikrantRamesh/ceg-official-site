...
(1, 9, 'ACM CEG Chapter', '💻', 'hello', '{\"website\":\"https://auceg.acm.org/\",\"instagram\":\"\",\"facebook\":\"acm_ceg\",\"twitter\":\"\",\"linkedin\":\"\",\"youtube\":\"\"}', '\\uploads\\acmceg-logo.png', NULL, 'https://auceg.acm.org/', '[{\"name\":\"Ansh 💣\",\"role\":\"Chair Person\"},{\"name\":\"Shiyam Ganesh\",\"role\":\"Vice Chair Person\"},{\"name\":\"Varsha M\",\"role\":\"Content director\"}]'),
(2, 9, 'hello', '💻', 'hello', '{\"website\":\"https://auceg.acm.org/\",\"instagram\":\"\",\"facebook\":\"acm_ceg\",\"twitter\":\"\",\"linkedin\":\"\",\"youtube\":\"\"}', '\\uploads\\acmceg-logo.png', NULL, 'https://auceg.acm.org/', '[{\"name\":\"Ansh 💣\",\"role\":\"Chair Person\"},{\"name\":\"Shiyam Ganesh\",\"role\":\"Vice Chair Person\"},{\"name\":\"Varsha M\",\"role\":\"Content director\"}]');
...
INSERT INTO `club_events` (`id`, `clubid`, `title`, `description`, `link`) VALUES
(1, 1, 'byeo world', '', 'netflix.com/helloworld');
...
ALTER TABLE `club_events`
  ADD CONSTRAINT `clubid_fk` FOREIGN KEY (`clubid`) REFERENCES `clubs` (`id`);
COMMIT;
